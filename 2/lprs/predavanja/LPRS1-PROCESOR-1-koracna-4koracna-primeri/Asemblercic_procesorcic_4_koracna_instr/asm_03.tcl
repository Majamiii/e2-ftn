...
set asm_file  "Primer_03_faktorijel/asm/p03.asm"
...
if {$result} {
	...
	insert_to_vhd $asm_bare.o.txt Primer_03_faktorijel/hdl/instr_rom.vhd \
		$ir_vhd_beg $ir_vhd_end
	insert_to_vhd $asm_bare.o.dat Primer_03_faktorijel/hdl/data_ram.vhd \
		$dr_vhd_beg $dr_vhd_end
	
	puts "LPRS1 assembling OK."
}
