...
begin
   ...
   begin
		...
		--POSTAVI sDATA na 1 ukupno 2 perioda
		sDATA <= "00000001";
		wait for 2 * iCLK_PERIOD;
		
		-- učitaj vrednost sDATA 2 perioda
		sLOAD <= '1';
		wait for 2 * iCLK_PERIOD;
		
		-- logički ulevo pomeraj vrednost 7 perioda
		sLOAD <= '0';
		sSHL <= '1';
		sSHR <= '0';
		sARITH <= '0';
		...
		-- logički udesno pomeraj vrednost 7 perioda
		sLOAD <= '0';
		sSHL <= '0';
		sSHR <= '1';
		sARITH <= '0';
		...
		-- aritmetički ulevo pomeraj vrednost 7 perioda
		sLOAD <= '0';
		sSHL <= '1';
		sSHR <= '0';
		sARITH <= '1';
		...
		-- promeni vrednost sDATA na 255 (bez perioda)
		sDATA <= "11100111";
		
		-- aritmetički udesno pomeraj vrednost 7 perioda
		sLOAD <= '0';
		sSHL <= '0';
		sSHR <= '1';
		sARITH <= '1';
