...
public:
    ...
    void dma(DMA_transfer trans) {
        ...
        transfer = trans;                           // Transfer deljeno polje dobija vrednost trans. Posmatrati kao razmenu podataka između dve niti (procesor i DMA kontroler).
    ...
    DMA_transfer okidac_dma_kontrolera() {
        ...
        while(stanje != DMA && !kraj)                        // Kontroler čeka da jedan od procesora zatraži DMA prenos.
