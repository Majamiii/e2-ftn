...
void ispisiIgru(const Igra& igra){
    cout<<"--- IGRA ---"<<endl;
    cout<<"Igrac: "<<endl;
    igra.i.ispis(); //poziv metode za ispis iz igraca. posto je prijateljska funkcija direktno mogu pristupiti polju i koje je private
...
int main(){
    srand(time(0)); // da ne bismo uvek dobijali iste nasumicne brojeve
