# preuzeto od coma007 sa github-a

from lista import SinglyLinkedListNode
...
class DoublyLinkedList(object):
    ...
    def __init__(self):
        self._head = SinglyLinkedListNode(None)
        self._tail = SinglyLinkedListNode(None)
    ...
    def add_first(self, data):
        ...
        node = SinglyLinkedListNode(data, old_first, self._head)
    ...
    def insert_after(self, existing, new):
        new_node = SinglyLinkedListNode(new)
        for node in self:
